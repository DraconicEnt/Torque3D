...
class LaserProjectileData : public ProjectileData {
   ...
   public:
        ...
        DECLARE_IMAGEASSET_ARRAY(LaserProjectileData, materialList, maxTextures);
        DECLARE_IMAGEASSET_ARRAY_SETGET(LaserProjectileData, materialList);
