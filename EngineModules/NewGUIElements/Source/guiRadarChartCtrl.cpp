...
void GuiRadarChartCtrl::onRender(Point2I offset, const RectI &updateRect)
{
    ...
    GFXDrawFunctions_drawPolygonTexture(description,
    ...
    for (U32 iteration = 0; iteration < profile->mNumberOfSides; ++iteration)
    {
        ...
        GFXDrawFunctions_drawLineWidthTextured(currentVertex.x, currentVertex.y, 0.0f,
...
{
    addGroup("Chart");
        addField("numberOfSides", TypeS32, Offset(mNumberOfSides, GuiRadarChartCtrlProfile), "Number of sides");
